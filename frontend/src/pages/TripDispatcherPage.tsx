...
export function TripDispatcherPage() {
    ...
    return (
        <div className="space-y-4 w-full px-6 py-4">
            ...
            <Card className="p-6 rounded-xl border-border bg-card mt-4">
                <div>
                    <h2 className="text-lg font-semibold tracking-tight text-foreground">Schedule New Trip</h2>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <Select value={vehicleId} onValueChange={setVehicleId}>
                                <SelectTrigger autoFocus className="w-full h-10 border-border focus:ring-2 focus:ring-ring focus:ring-offset-1 rounded-lg transition-all duration-150">
