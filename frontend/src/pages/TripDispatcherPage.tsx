        ...
        >
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
                <div className="space-y-1">
                    <h1 className="text-2xl font-semibold tracking-tight text-gray-900">Trip Dispatcher Overview</h1>
                    <p className="text-sm text-gray-500">Monitor active routes and assign new trips.</p>
                </div>
            </div>

            <Card className="rounded-xl border border-gray-200 overflow-hidden mb-4 bg-white">
            ...
            {canSchedule ? (
                <Card className="p-6 rounded-xl border border-gray-200 bg-white mt-4 relative overflow-hidden group">
                ...
                <Card className="p-12 rounded-xl border border-dashed border-gray-300 bg-gray-50/50 flex flex-col items-center justify-center text-center mt-4">
                    <div className="w-12 h-12 rounded-full bg-gray-100 flex items-center justify-center mb-4 text-gray-400">
                        <MapPin className="w-6 h-6" />
                    </div>
                    <h3 className="text-base font-medium text-gray-900">Trip Scheduling Restricted</h3>
                    <p className="text-sm text-gray-500 max-w-xs mt-1">Operational actions are restricted for your current role ({role}). Contact a manager for access.</p>
                </Card>
            )}
        </motion.div>
    );
