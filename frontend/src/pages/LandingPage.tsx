                            ...
                            <Card className="w-full h-full border-border shadow-md hover:shadow-lg transition-shadow duration-300 rounded-[2.5rem] bg-card/95 dark:bg-muted/20 backdrop-blur-sm overflow-hidden flex flex-col justify-center">
                                <CardContent className="p-8">
                                    ...
                                    <form onSubmit={handleLogin} className="space-y-5">
                                        ...
                                        <Button type="submit" disabled={isLoggingIn} className="w-full h-10 rounded-lg font-medium bg-primary text-primary-foreground hover:bg-primary/90 focus-visible:ring-2 focus-visible:ring-ring transition-all mt-4 shadow-sm hover:shadow-md active:scale-95">
